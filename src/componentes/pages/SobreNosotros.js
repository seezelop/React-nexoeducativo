    ...
    render() {
        return (
            ...
            <div className="container p-4 pb-0">
                ...
                <p className="pSobreNosotros">
                    En 2024, los estudiantes de la carrera de Analista de Sistemas, Martina Asad y Sebastian Lopez
                    se dieron cuenta de que la complejidad de realizar tareas administrativas en los 
                    ...
                    la tecnologia para tener todo la informacion necesario en un solo de manera intuitiva.
                </p>
                <p className="pSobreNosotros">Desde entonces, Nexo Educativo ha ido más allá de las plataformas
                    educativas actuales convirtiendose en una plataforma simple, enfocada en usuarios de todas
